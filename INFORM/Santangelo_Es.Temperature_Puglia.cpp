/*
	Name: Gianluigi_Temperatura
	Copyright: Colamonico Chiarulli
	Author: Antonio Solare
	Date: 15/02/23 13:47
	Description: Dati in input due vettori di sei numeri interi contenenti le temperature minime registrate in due giorni diversi nei capoluoghi di provincia pugliesi, calcolare la media di ciascun giorno, dare in output la media stessa e dire quale vettore ha la media pi? alta.
*/
